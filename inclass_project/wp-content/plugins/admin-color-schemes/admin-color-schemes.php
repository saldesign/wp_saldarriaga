...
class ACS_Color_Schemes {
	...
	function add_colors() {
		...
		wp_admin_css_color(
			'new', __( 'New', 'admin_schemes' ),
			plugins_url( "new/colors$suffix.css", __FILE__ ),
			array( '#1A1D1A', '#8AB0AB', '#F2B880', '#0D3B66' ),
			array( 'base' => '#1A1D1A', 'focus' => '#F8F6F1', 'current' => '#F8F6F1' )
		);
